    ...
    <footer className="bg-slate-900 text-slate-400 py-16 px-6">
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-10 text-xs md:text-sm font-bold uppercase tracking-widest">
          <a className="hover:text-brand-sky transition-colors" href="#">Privacy Policy</a>
          <a className="hover:text-brand-sky transition-colors" href="#">Terms of Service</a>
          <a className="hover:text-brand-sky transition-colors" href="#">Contact Us</a>
          <a className="hover:text-brand-sky transition-colors" href="#">Services</a>
        </div>
        ...
        <div className="flex gap-6 mb-12">
          {[
            ...
            { id: 'li', d: "M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" }
          ].map(social => (
            <a key={social.id} className="w-12 h-12 flex items-center justify-center rounded-full bg-slate-800 hover:bg-brand-sky hover:text-white transition-all transform hover:scale-110 shadow-lg" href="#">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d={social.d}></path></svg>
            </a>
          ))}
        </div>
        ...
        <div className="text-xs text-slate-500 text-center font-medium tracking-wide">
          &copy; {new Date().getFullYear()} EverBright Roof Cleaning & Protection. All Rights Reserved.
        </div>
      </div>
    </footer>
  );
